...
STYLE = """
    ...
    * { box-sizing: border-box; }
    ...
    .family-card .fc-mark { width: 34px; height: 34px; border-radius: var(--r-sm); background: rgba(23,212,250,.10); display: inline-flex; align-items: center; justify-content: center; flex-shrink: 0; }
    .family-card .fc-mark img { width: 24px; height: 24px; display: block; }
